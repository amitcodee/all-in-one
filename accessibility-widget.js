(function () {
  /************************************************************
   * Piece 1: Global State & Helper Functions
   ************************************************************/
  ...
  // Reset all accessibility settings (remove forced classes and reset toggles)
  function resetAccessibilitySettings() {
    ...
    // Reset inline styles (e.g., cursor, colors)
    document.body.style.cursor = "auto";
    document.body.style.color = "";
    document.body.style.backgroundColor = "";

    // Reset toggles and descriptions in the panel
    widgetPanel.querySelectorAll('input[type="checkbox"]').forEach(cb => cb.checked = false);
    widgetPanel.querySelectorAll(".profile-description").forEach(desc => desc.classList.remove("active"));
  }
  ...
  /************************************************************
   * Piece 2: Voice Navigation Functions
   ************************************************************/
  ...
  // Helper: Create a feature button with ARIA support
  ...
  /************************************************************
   * Piece 7: Voice Navigation Functions
   ************************************************************/
  function startVoiceNavigation() {
    if (!recognition) recognition = initVoiceNavigation();
    isVoiceNavActive = true;
  ...
  /************************************************************
   * Piece 8: Attach Widget to Document
   ************************************************************/
